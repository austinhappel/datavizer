...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'DataType', fields ['owner', 'name']
        db.create_unique(u'data_management_datatype', ['owner_id', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'DataType', fields ['owner', 'name']
        db.delete_unique(u'data_management_datatype', ['owner_id', 'name'])
