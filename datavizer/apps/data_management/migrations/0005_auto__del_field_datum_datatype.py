...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Datum.datatype'
        db.delete_column(u'data_management_datum', 'datatype_id')


    def backwards(self, orm):
        # Adding field 'Datum.datatype'
        db.add_column(u'data_management_datum', 'datatype',
